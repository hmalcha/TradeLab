...
class Momentum(Strategy):
    ...
    def __init__(self, tickers, start_time, end_time, offset="0D", rebalance_frequency=30, momentum_lookback=5, buy_top_n=1):
    ...
    def _compute_momentum(self, ticker, timeline, data_handler, t):
        ...
        # Find day at least 20 days before t in timeline
        ...
        # Get price from 20 days ago and from today
